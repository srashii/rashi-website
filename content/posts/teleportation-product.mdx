...
|--------------------|---------------|-----------|---------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| Shipping           | High          | High      | Strong Competitors Exist,  like Amazon, Movers & Packers etc. | **High Cost** of Warehouse, People, Maintenance, Transportation &  **High Delivery Time** atleast more than 24 hrs | High: Because if we look at current costs, volume & time restrictions - Teleportation can actually be a game changer              |
| Delivery           | High          | High      | Strong Competitors Exist,  like Talabat, Blinkit etc.         | Cost of People (Delivery time is actually under 40 mins, so not a pain point)                                      | Low: Because the cost &amp; time are already very optimised, so the cost to implement Teleportation will not bring back any gains |
