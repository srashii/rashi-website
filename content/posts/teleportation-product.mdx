...
But if I look at product fit for “Teleportation”, I would ❌ **Transportation of People** the main reasons being: 
...
| --- | --- | --- | --- | --- | --- |
| Shipping | High | High | Strong Competitors Exist, like Amazon, Movers & Packers etc. | **High Cost** of Warehouse, People, Maintenance, Transportation is  & **High Delivery Time** atleast more than 24 hrs | **High**: Because if we add all the costs required and the volume & time restrictions - Teleportation can actually be a game changer |
| Delivery | High | High | Strong Competitors Exist, like Talabat, Blinkit | **Cost of People** (Delivery time is actually under 40 mins, so not a pain point) | **Low**: Because the cost & time are already very optimised, so the cost to implement Teleportation will not bring back any gains |
| Emergency Services | Medium | Medium | Low Competitors | Meeting **time sensitivity** requirement & high pressure execution| **High**: Because in times of emergency time is of the essence, so this can bring a very High impact |
