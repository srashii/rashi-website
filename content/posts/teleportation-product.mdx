...
4. What is the success to fail ratio for the product in all the trial runs we have done? *For sake of our discussion we kept 95% as the success rate, ie. out of 100 times, 5 times it may fail*
5. Is this technology new, or there are any competitors out there doing something with this technology? *It is the first of it’s kind*
6. Is it safe to assume it’s expensive than other commute related mediums already available like, flights, ships, cars etc.? *We were aligned on this assumption* 
7. How much volume and frequency can we take in? Are there any restrictions in terms of weight? *Again for the sake of our discussion, we assumed the weight to be 200 kgs and frequency to be 20 slots per day as it’s a new technology initially we want more time for maintenance. For rest we assumed no other restrictions.*
...
But if I look at product fit for “Teleportation”, I would ignore the whole **“**❌ **Transportation of People** the main reasons being: 
...
With these concerns gaining the trust of users here sounds like an extremely long game.
...
| --- | --- | --- | --- | --- | --- |
| Shipping | High | High | Strong Competitors Exist, like Amazon, Movers & Packers etc. | 1. Cost of Warehouse, People, Maintenance, Transportation is High
2. There is a certain delivery time which it adheres to which is generally atleast more than 24 hrs | High

Because if we add all the costs required and the volume & time restrictions - Teleportation can actually be a game changer |
| Delivery | High | High | Strong Competitors Exist, like Talabat, Blinkit | Cost of People

(Delivery time is actually under 40 mins, so not a pain point) | Low

Because the cost & time are already very optimised, so the cost to implement Teleportation will not bring back any gains |
| Emergency Services | Medium | Medium | Low Competitors | 1. Time sensitivity is high so meeting it becomes very important
2. Cost of resources | High

Because in times of emergency time is of the essence, so this can bring a very High impact |
...
| Problems | Will need to figure out the right pricing point so that these big players can see the benefit, and we can gain volume & revenue

So the problem is something we can control | Working with Govt. means a lot of policies which we will need adhere to, and the process of getting the approval to actually launch will be slower 

So the problem might be out of our control |
| Priority | P0 | P1 |
...
### Additional & Important Step: Ensure the Responsible Usage of the Product, because:
...
<aside>
🧠 **These kind of case studies are fun to solve, and this one is particularly interesting for me because it pushes me to bring a sci-fi technology to reality and figure out how it can fit together. Who would not want a little bit of “cool-tech” in there daily life?!**
