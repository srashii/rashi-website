...
export const siteConfig = {
  siteTitle: 'Rashi Srivastava',
  firstName: 'Rashi',
  lastName: 'Srivastava',
  description: `👋 Hi, I'm Rashi Srivastava!/n
  A versatile product manager with almost 7 years of experience in building & scaling products from 0 to 1./nAs a Lead Product Manager, I navigate the dynamic landscape of product development, blending innovation with user-centric design. This blog is a space where I share my experiences, insights, and both real-world and imaginative case studies to explore the "what ifs" of technology.`,
  header: {
    logoName: 'Rashi'
  },
  socialLinks: {
  ...
  experience: [
    ...
    {
      companyName: "IND Money",
      role: "Associate Product Manager",
      timePeriod: "2020 - 2021",
      description: `
      - Developed the Loan Against Investments product vertical from inception\n
      - Designed numerous marketing campaign experiments, conducting weekly A/B tests that resulted in a 40% surge in acquired leads\n
      - Enhanced bank loan approval rates by 7% through the implementation of technology-driven and process-led adjustments`
    }
  ]
}
